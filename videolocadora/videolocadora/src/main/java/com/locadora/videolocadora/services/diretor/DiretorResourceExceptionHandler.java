...
@ControllerAdvice
public class DiretorResourceExceptionHandler {
    @ExceptionHandler(DiretorNaoEncontradoException.class)
    public ResponseEntity<ErroPadrao> diretorNaoEncontardoHandler(DiretorNaoEncontradoException e, HttpServletRequest req){
